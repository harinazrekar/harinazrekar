...
[![Typing SVG](https://readme-typing-svg.demolab.com?font=Playfair+Display&weight=700&size=22&pause=999999&color=C8C0FF&center=true&vCenter=true&multiline=true&repeat=false&width=760&height=120&lines=The+truth+is+one%2C+but+there+are+a+million+ways+to+get+to+it.;Truth+is+a+pathless+land+-+no+system%2C+no+guru%2C+no+authority+can+lead+you+to+the+truth.)](https://git.io/typing-svg)
